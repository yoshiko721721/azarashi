...
//2024/11/14 中江
//--------------------------------------------------------------
bool BoxCollider::CheckCollision_Box_Circle(Object* m_GamePlayer, float Scaffoldposx, float Scaffoldposy, float angle, float wihtd, float height)
{
    ...
    DirectX::XMFLOAT2 halfsize = { wihtd / 2,height / 2 };
