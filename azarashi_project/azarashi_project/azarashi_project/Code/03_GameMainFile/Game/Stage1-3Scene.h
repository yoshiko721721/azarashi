...
class Stage1_3Scene : public Scene
{
private:
	Object sample;
	GameClearUI clearUI;
...
public:
	...
	std::string fileName = "Code/12_CSVMapLoader/Stage1_3.csv"; //ステージサイズ
	Stage1_3Scene(std::vector<ID3D11ShaderResourceView*>& textures);
	void Init(); //初期化 
	void Update(); //更新 
	void Draw(); //描画 
	void Uninit(); //終了
